...
public class PrismConfig extends ConfigBase {
	...
	public FileConfiguration getConfig() {
		...
		final List<Integer> illegalBlocks = new ArrayList<>();
		...
		oreBlocks.put(Material.IRON_ORE.name(), "&6");
		oreBlocks.put(Material.GOLD_ORE.name(), "&7");
		oreBlocks.put(Material.LAPIS_ORE.name(), "&9");
		oreBlocks.put(Material.DIAMOND_ORE.name(), "&b");
		oreBlocks.put(Material.EMERALD_ORE.name(), "&a");
		...
		monitorItems.add(Material.BEDROCK.name());
		monitorItems.add(Material.TNT.name());
		monitorItems.add(Material.LAVA.name());
		monitorItems.add(Material.COMMAND_BLOCK.name());
